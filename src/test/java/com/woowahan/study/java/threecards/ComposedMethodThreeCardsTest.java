...
public class ComposedMethodThreeCardsTest {
    ...
    @Test
    void 결과가_없는_경우() throws Exception {
    ...
    @Test
    void 세카드_중_중복_허용() throws Exception {
    ...
    @Test
    void 결과가_하나_이상인_경우() throws Exception {
        List<Integer> cards = asList(1, 2, 3, 4, 5);
        int target = 8;
